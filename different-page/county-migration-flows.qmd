...
The following data come from the U.S. Census Bureau's County-to-County Migration Flows dataset. Figure \@fig-results shows net migration for Kansas counties. Table @results shows inflow, outflow, and net flow by county. Net flow (i.e., migration) is given by the following simple calculation:
